...
<aside class="fxr-main-sidebar" id="fxrMainSidebar">
  ...
  <style>
    ...
    .fxr-hamburger-btn { display: flex; flex-direction: column; gap: 4px; background: transparent; border: none; cursor: pointer; padding: 4px; border-radius: 4px;}
...
// index 11 is line 12. index 25 is line 26.
const newContent = lines.slice(0, 11).join('\n') + '\n' + newHeader + lines.slice(26).join('\n');
fs.writeFileSync(filePath, newContent, 'utf8');

console.log("register.html updated successfully!");
